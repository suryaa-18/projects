      ...
      <div className="container">
        <div className="footer__container grid">
          <div className="footer__content">
            <a href="#" className="footer__logo">Surya K</a>
            <p className="footer__description">A Fresh Enthusiastic Computer Science Graduate</p>
          </div>
          <div className="footer__socials">
            ...
            <a
              href="mailto:surya.k7880@gmail.com"
              className="footer__social"
              aria-label="Email"
            >
